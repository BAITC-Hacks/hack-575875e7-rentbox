...
Сравнены 1204 конфигураций на CPU, RTX 5090 Laptop и A6000 в NVIDIA Brev.
...
Выбран top_3_mean: cloud-gpu_004, rtx5090_0149, a6000_0023.
MAE ноября–декабря: 0.16261. Выбор зафиксирован до повторной оценки января.
...
| Горизонт | MAE | RMSE |
|---|---:|---:|
| Все выпуски | 0.16945 | 0.24986 |
| 1-24h | 0.15966 | 0.23530 |
| 25-48h | 0.17956 | 0.26407 |
...
Первый бустинг из `artifacts/forecast/` давал MAE 0.19420. Этот ансамбль: MAE 0.16945.

## Использование

```bash
python -m scripts.predict --as-of 2026-01-31T18:00:00Z --horizon 48 --model artifacts/expanded/model.joblib
```
