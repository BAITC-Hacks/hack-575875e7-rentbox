...
> = {
  flow: {
    ...
    subtitle: "к энергии.",
    detail:
      "Выберите час — мощность показана по прогнозу модели. Без значений ветра скорость вращения не рассчитывается.",
  },
  icing: {
    label: "Обледенение",
    title: "Холод меняет",
    ...
    detail:
      "Учебный сценарий: голубой слой показывает лёд на лопастях. Погодные значения и датчик льда в этом ответе отсутствуют.",
  },
  cutaway: {
    label: "В разрезе",
    title: "Энергия",
